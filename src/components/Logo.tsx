...
const Logo = ({ fill = 'white', width = 100, height = '100%' }: Props): JSX.Element => {
  return (
    <svg version='1.1' x='0px' y='0px' viewBox='0 0 400 50' width={width} height={height} fill={fill}>
      ...
      <g className='letter_x'>
        <path fill={fill} className='fill-white' d='M287.6,18.6H273l17.2,12.6c2.5-1.7,5.4-3.5,8-5L287.6,18.6z'></path>
        <path fill={fill} className='fill-white' d='M308.8,34.3c-2.5,1.7-5,3.6-7.4,5.4l13,9.5h14.7L308.8,34.3z'></path>
      </g>
